...
public class GameConstants {
    ...
    // Random Portal
    public static final int RANDOM_PORTAL_SPAWN_CHANCE = 0/*500*/; // out of a 1000 (50%)
    ...
    // BurningField
    public static final int BURNING_FIELD_MAX_LEVEL = 0/*10*/; //Maximum Burning Field Level
    ...
    public static final int BURNING_FIELD_MIN_MOB_LEVEL = 0/*250*/; //Minimum Mob Level for the Field to become a Burning Field
    ...
    public static final int ELITE_MOB_RESPAWN_TIME = 60/*120*/; // seconds
    public static final int ELITE_MOB_SPAWN_CHANCE = 10/*5*/; // out of a 1000
    ...
    public static final String ELITE_BOSS_BGM = "Bgm35/RoyalGuard"/*"Bgm45/Anthem For Heroes"*/;
