...
//        outPacket.encodeInt(getPrevBonusExpRate());
        ...
        for (int i = 0; i < 4/*3*/; i++) {
            ...
            if (i == 3) {
                ...
                outPacket.encodeInt(getSocket(i));
            }
        }
        ...
        outPacket.encodeByte(0); // ブランド印章 flag要等於0x80還有這個等於1才會顯示「owner」の渾身の力作
        outPacket.encodeInt(getSoulOptionId() * 100 + getSoulSocketId());
