...
//        outPacket.encodeInt(0); // TODO figure out
        ...
        outPacket.encodeByte(5/*getPvpModeType()*/);
...
//        outPacket.encodeByte(isBurning()); // bBurning
        ...
        outPacket.encodeFT(getLastLogout()); // 最後更新性向稱號時間
        outPacket.encodeInt(5); // 0 = 領導力 1 = 洞察 2 = 意志 3 = 手藝 4 = 感性 5 = 魅力
        outPacket.encodeInt(5); // 性向等級
    }
