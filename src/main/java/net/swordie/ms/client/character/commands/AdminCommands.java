...
public class AdminCommands {
    ...
    @Command(names = {"packet", "p"}, requiredType = Admin)
...
//            outPacket.encodeArr(new byte[Integer.parseInt(args[1])]);
    ...
    @Command(names = {"i", "item"}, requiredType = GameMaster)
    ...
    @Command(names = {"w", "warp"}, requiredType = Tester)
    ...
    @Command(names = {"s"}, requiredType = Tester)
